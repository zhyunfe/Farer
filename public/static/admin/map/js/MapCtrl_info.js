...
function refresh() {
		...
		'<div id="all_dizhi" class="am-u-md-6">'+
			...
			'<div id="info">'+
				'<div>'+
				    ...
				    '<script class="resources library" src="../../static/admin/map/js/area.js" type="text/javascript"></script>    '+
			...
			'<div id="result">	'+
			'<a id="cleanAll"  title="清除所有遮盖物"><img src="../../static/admin/map/images/dt1.png" ></a>'+
			'</div>'+
			'<div id="xy"></div>'+
	...
	$.ajax({
		method: 'GET',
		url: '../../static/admin/map/MapCtrl.xml',
